...
<div class="row">
	<div class="col-md-12">
		...
		<h2 class="text-center">
			<%=resourceBundle.getString("TITRE_PRIS_EN_CHARGE")%>
		</h2>
	</div>
	<br> <br>
		...
		<div class="row mix" style="width: 100%"
			...
			<div class="panel panel-primary col-md-10 col-md-offset-1 col-xs-11 col-xs-offset-1 orderForDelivery">
				<div class="col-md-4 col-xs-11">
					...
					<h5>
						<%=resourceBundle.getString("COMMANDE_ACCEPTE_DATE")%>
					...
					<form method=get action="<c:url value="/OrderFinishToBeDelivered"/>">
						...
						<button type="submit" class="col-md-6 col-md-offset-0 col-xs-offset-2 col-xs-10 btn btn-default btn-md">
