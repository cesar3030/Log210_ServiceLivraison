...
/**
 * source pour etablir la requête Post Http : http://blog.idleman.fr/snippet-7-java-faire-une-requete-http-en-post-et-en-get/
...
public class ExpressLivraisonSms {
	 ...
	 * devant etre indiqués pour envoyer un sms
	 * soit : 
	 * 		String number
	 * 		String message 
	 */
	 ...
	 * @param numeroTel (le numéro de telephone du client)
	...
	public void envoyerSmsConfirmationInsciptionAuSite(String numeroTel,String addressMailClient) throws IOException{
		...
		values.add("Bonjour : "+addressMailClient+", merci d'avoir procédé à votre inscription. Desormais,"
	...
	public String post(String address,ArrayList<String> keys, ArrayList<String> values) throws IOException{
		...
		//création de la connection vers l'adresse url du site internet
		URL url = new URL(address);
		URLConnection conn = url.openConnection();
		conn.setDoOutput(true);

		//on envoie la requête pour envoyer le texto selon les parametre fourni
