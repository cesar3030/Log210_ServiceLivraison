	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(idAddress==-1)
		{
			...
			if(idAddress<0 || idAddress==0)
			{
				...
				continute=false;
				System.out.println("Une erreur est survenue lors de la cr̩ation en BD de la nouvelle adresse. Veuillez reessayer.");
				returnMessage.put("fail","Une erreur est survenue lors de la cr̩ation en BD de la nouvelle adresse. Veuillez reessayer.");
			}
