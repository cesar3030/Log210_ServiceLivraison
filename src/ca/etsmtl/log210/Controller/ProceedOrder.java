...
public class ProceedOrder extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		OrderToDeliverBean orderWithAllTheInformations = new OrderToDeliverBean();
				...
				if(continute == true)
				{
					...
					if(continute == true)
					{
						try {
							...
							//On garde toutes les informations de la commande dans une variable session pour y acceder depuis la page orderDone.jsp
							orderWithAllTheInformations.setAddress(deliveryAddress);
							orderWithAllTheInformations.setClient(client);
							orderWithAllTheInformations.setOrder(order);
